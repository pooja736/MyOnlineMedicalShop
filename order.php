...
if(isset($_GET['c_id'])){
 ...
 $run_email = mysqli_fetch_array($con,$c_email);

 $customer_email = $run_email['customer_email'];
 $customer_name =$run_email['customer_name'];
}
  

  //Getting products & number of items
...
$ip_add = getRealIpAddr();
		...
		$run_order = mysqli_query($con,$insert_order);
			...
			<html>
			<p>
			Hello dear<b style='bule';>$customer_name</b>You have ordered some products on our website mymedical.com, please fine your  order details below and pay the as soon as possible,so we can proceed your order. Thank you!</p>
			<table width='600' align='center' bgcolor='#FFCC9' border='2'>
			<tr><td><h2>Youe Order Details from mysite.com<h2></td><tr>
			<tr>
			<th><b>S.N</b></th>
			...
			<h2> <a href='medical.com'>Click here</a> to login to your account </h2>

			<h3>Thank you for oder on -www.medical.com</h3>
