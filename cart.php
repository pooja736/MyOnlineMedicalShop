		...
		<div class="content_wrapper">
			...
			<div id="right_content">
				...
				<div id="headline">
					...
					?>
						<span> -Total Item:<?php items(); ?> -Total Price:<?php total_price();?> -<a href="index.php"style="color: #FF0;">Back to select Medicine</a>
...
?>
		...
		<tr>
				...
				<td><?php echo $product_title; ?><br><img src="admin_area/product_images/<?php   
				echo $product_image; ?>" height="70" width="70"></td>
				...
				<?php }} ?>
					...
					<tr></tr>
						<tr>
							...
							<td><input type="submit" name="continue" value="continue Shooping"/></td>
							<td><button><a href="Checkout.php" style="text-decoration: none; color:#000">Checkout</button></a></td>
						</tr>
